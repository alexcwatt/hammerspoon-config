--- === Elgato Key Light ===
--- Source: https://github.com/evantravers/hammerspoon-config/blob/master/Spoons/ElgatoKey.spoon/init.lua
local M = {
...
local function setSettings(settings)
    local status, response, header = hs.http.doRequest("http://" .. M.ip() .. ":" .. M.port() .. "/elgato/lights",
        "PUT", hs.json.encode(settings))
end
